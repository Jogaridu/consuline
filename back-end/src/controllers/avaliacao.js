...
module.exports = {
    ...
    async mediaAvaliacaoMedico(ProfissionalDaSaudeId) {

        try {
            const avaliacoes = await Avaliacao.findAll({
                where: { ProfissionalDaSaudeId },
                raw: true,
                attributes: ["estrelas"]
            });
            ...
            avaliacoes.forEach(e => soma += e.estrelas);

            media = Math.floor(soma / avaliacoes.length);
